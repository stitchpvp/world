...
public:
  ...
  template <class Data>
  void setSubstructSubstructDataByName(const char* substruct_name1, const char* substruct_name2, const char* name, Data data, int32 substruct_index1 = 0, int32 substruct_index2 = 0, int32 index = 0) {
    char tmp[15] = {0};
  ...
  template <class Data>
  void setSubstructDataByName(const char* substruct_name, const char* name, Data data, int32 substruct_index = 0, int32 index = 0) {
    char tmp[10] = {0};
  ...
  template <class Data>
  void setSubstructColorByName(const char* substruct_name, const char* name, Data data, int32 substruct_index = 0, int32 index = 0) {
    char tmp[10] = {0};
    sprintf(tmp, "_%u", substruct_index);
    string name2 = string(substruct_name).append("_").append(name).append(tmp);
  ...
  template <class Data>
  void setSubstructArrayDataByName(const char* substruct_name, const char* name, Data data, int32 index = 0, int32 substruct_index = 0) {
    char tmp[10] = {0};
    sprintf(tmp, "_%u", substruct_index);
    string name2 = string(substruct_name).append("_").append(name).append(tmp);
  ...
  template <class Data>
  void setSubstructArrayColorByName(const char* substruct_name, const char* name, Data data, int32 substruct_index = 0, int32 index = 0) {
    char tmp[10] = {0};
    sprintf(tmp, "_%u", substruct_index);
    string name2 = string(substruct_name).append("_").append(name).append(tmp);
  ...
  template <class Data>
  void setDataByName(const char* name, Data data, int32 index = 0, bool use_second_type = false) {
  ...
  template <class Data>
  void setSubArrayDataByName(const char* name, Data data, int32 index1 = 0, int32 index2 = 0, int32 index3 = 0) {
    char tmp[20] = {0};
  ...
  template <class Data>
  void setArrayDataByName(const char* name, Data data, sint32 index1 = 0, int32 index2 = 0, bool use_second_type = false) {
    char tmp[10] = {0};
  ...
  template <class Data>
  void setData(DataStruct* data_struct, Data* data, int32 index, bool use_second_type = false) {
    if (!data_struct)
      return;
  ...
  template <class Data>
  void setSubArrayLengthByName(const char* name, Data data, int32 index1 = 0, int32 index2 = 0) {
    char tmp[10] = {0};
    sprintf(tmp, "_%u", index1);
    string name2 = string(name).append(tmp);
  ...
  template <class Data>
  void setArrayLengthByName(const char* name, Data data, int32 index = 0) {
    DataStruct* data_struct = findStruct(name, index);
    setData(data_struct, data, index);
    UpdateArrayByArrayLength(data_struct, index, data);
  }
  template <class Data>
  void setSubstructArrayLengthByName(const char* substruct_name, const char* name, Data data, int32 substruct_index = 0, int32 index = 0) {
    char tmp[10] = {0};
    sprintf(tmp, "_%u", substruct_index);
    string name2 = string(substruct_name).append("_").append(name).append(tmp);
