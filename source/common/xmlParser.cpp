...
char *_tcsstr(const char *c1, const char *c2) { return const_cast<char*>(strstr(c1,c2)); }
char *_tcschr(const char *c1, int c2) { return const_cast<char*>(strchr(c1,c2)); }
char *_tcscpy(char *c1, const char *c2) { return const_cast<char*>(strcpy(c1,c2)); }
#endif
...
// private:
LPCTSTR fromXMLString(LPCTSTR s, int lo)
{
