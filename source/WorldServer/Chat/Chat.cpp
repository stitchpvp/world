...
EQ2Packet * Chat::GetWorldChannelList(shared_ptr<Client> client) {
...
bool Chat::IsInChannel(shared_ptr<Client> client, const char *channel_name) {
	vector<ChatChannel *>::iterator itr;
	bool ret = false;
...
bool Chat::JoinChannel(shared_ptr<Client> client, const char *channel_name) {
	vector<ChatChannel *>::iterator itr;
	bool ret = false;
...
bool Chat::LeaveChannel(shared_ptr<Client> client, const char *channel_name) {
	vector<ChatChannel *>::iterator itr;
	bool ret = false;
...
bool Chat::LeaveAllChannels(shared_ptr<Client> client) {
	vector<ChatChannel *>::iterator itr;
	ChatChannel *channel;
	bool erased;
...
bool Chat::TellChannel(shared_ptr<Client> client, const char *channel_name, const char *message, const char* name) {
	vector<ChatChannel *>::iterator itr;
	bool ret = false;
...
bool Chat::SendChannelUserList(shared_ptr<Client> client, const char *channel_name) {
	vector<ChatChannel *>::iterator itr;
	bool ret = false;
