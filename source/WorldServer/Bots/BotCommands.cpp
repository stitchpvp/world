...
void Commands::Command_Bot(const shared_ptr<Client>& client, Seperator* sep) {
...
void Commands::Command_Bot_Create(const shared_ptr<Client>& client, Seperator* sep) {
	int8 race = BARBARIAN;
	int8 gender = 0;
...
void Commands::Command_Bot_Customize(const shared_ptr<Client>& client, Seperator* sep) {
	Bot* bot = 0;
	if (client->GetPlayer()->GetTarget() && client->GetPlayer()->GetTarget()->IsBot())
...
void Commands::Command_Bot_Spawn(const shared_ptr<Client>& client, Seperator* sep) {
...
void Commands::Command_Bot_List(const shared_ptr<Client>& client, Seperator* sep) {
	string bot_list;
...
void Commands::Command_Bot_Inv(const shared_ptr<Client>& client, Seperator* sep) {
	if (sep && sep->IsSet(0)) {
...
void Commands::Command_Bot_Settings(const shared_ptr<Client>& client, Seperator* sep) {
...
void Commands::Command_Bot_Help(const shared_ptr<Client>& client, Seperator* sep) {
	if (sep && sep->IsSet(0)) {
