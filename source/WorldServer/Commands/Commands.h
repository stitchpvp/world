...
public:
  ...
  void addCommand(EQ2_RemoteCommandString add) {
...
public:
  Commands();
  ~Commands();
  bool SetSpawnCommand(const shared_ptr<Client>& client, Spawn* target, int8 type, const char* value, bool send_update = true, bool temporary = false, string* temp_value = 0);
  bool SetZoneCommand(const shared_ptr<Client>& client, int32 zone_id, ZoneServer* zone, int8 type, const char* value);
  RemoteCommands* GetRemoteCommands() { return remote_commands; }
  void Process(int32 index, EQ2_16BitString* command_parms, const shared_ptr<Client>& client);
  int32 GetCommandHandler(const char* name) {
  ...
  void Command_AcceptAdvancement(const shared_ptr<Client>& client, Seperator* sep);
  void Command_AFK(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Appearance(const shared_ptr<Client>& client, Seperator* sep, int handler);
  void Command_CancelMaintained(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Claim(const shared_ptr<Client>& client, Seperator* sep);
  void Command_ClearAllQueued(const shared_ptr<Client>& client);
  void Command_Create(const shared_ptr<Client>& client, Seperator* sep);
  void Command_CreateFromRecipe(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Distance(const shared_ptr<Client>& client);
  void Command_Duel(const shared_ptr<Client>& client, Seperator* sep);
  void Command_DuelBet(const shared_ptr<Client>& client, Seperator* sep);
  void Command_DuelAccept(const shared_ptr<Client>& client, Seperator* sep);
  void Command_DuelDecline(const shared_ptr<Client>& client, Seperator* sep);
  void Command_DuelSurrender(const shared_ptr<Client>& client, Seperator* sep);
  void Command_DuelToggle(const shared_ptr<Client>& client, Seperator* sep);
  void Command_EntityCommand(const shared_ptr<Client>& client, Seperator* sep, int handler);
  void Command_Follow(const shared_ptr<Client>& client, Seperator* sep);
  void Command_StopFollow(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Grid(const shared_ptr<Client>& client);
  void Command_Guild(const shared_ptr<Client>& client, Seperator* sep);
  void Command_CreateGuild(const shared_ptr<Client>& client);
  void Command_SetGuildOfficerNote(const shared_ptr<Client>& client, Seperator* sep);
  void Command_SetGuildMemberNote(const shared_ptr<Client>& client, Seperator* sep);
  void Command_OfficerSay(const shared_ptr<Client>& client, Seperator* sep);
  void Command_GuildSay(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Guilds(const shared_ptr<Client>& client);
  void Command_GuildsAdd(const shared_ptr<Client>& client, Seperator* sep);
  void Command_GuildsCreate(const shared_ptr<Client>& client, Seperator* sep);
  void Command_GuildsDelete(const shared_ptr<Client>& client, Seperator* sep);
  void Command_GuildsList(const shared_ptr<Client>& client);
  void Command_GuildsRemove(const shared_ptr<Client>& client, Seperator* sep);
  void Command_InspectPlayer(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Inventory(const shared_ptr<Client>& client, Seperator* sep, EQ2_RemoteCommandString* command);
  void Command_IRC(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Languages(const shared_ptr<Client>& client, Seperator* sep);
  void Command_SetLanguage(const shared_ptr<Client>& client, Seperator* sep);
  void Command_LastName(const shared_ptr<Client>& client, Seperator* sep);
  void Command_ConfirmLastName(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Location(const shared_ptr<Client>& client);
  void Command_LocationAdd(const shared_ptr<Client>& client, Seperator* sep);
  void Command_LocationCreate(const shared_ptr<Client>& client, Seperator* sep);
  void Command_LocationDelete(const shared_ptr<Client>& client, Seperator* sep);
  void Command_LocationList(const shared_ptr<Client>& client, Seperator* sep);
  void Command_LocationRemove(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Merchant(const shared_ptr<Client>& client, Seperator* sep, int handler);

  void Command_Modify(const shared_ptr<Client>& client); // usage function
  void Command_ModifyCharacter(const shared_ptr<Client>& client, Seperator* sep);
  void Command_ModifyFaction(const shared_ptr<Client>& client, Seperator* sep);
  void Command_ModifyGuild(const shared_ptr<Client>& client, Seperator* sep);
  void Command_ModifyItem(const shared_ptr<Client>& client, Seperator* sep);
  void Command_ModifyQuest(const shared_ptr<Client>& client, Seperator* sep);
  void Command_ModifySkill(const shared_ptr<Client>& client, Seperator* sep);
  void Command_ModifySpawn(const shared_ptr<Client>& client, Seperator* sep);
  void Command_ModifySpell(const shared_ptr<Client>& client, Seperator* sep);
  void Command_ModifyZone(const shared_ptr<Client>& client, Seperator* sep);

  void Command_MOTD(const shared_ptr<Client>& client);
  void Command_Pet(const shared_ptr<Client>& client, Seperator* sep);
  void Command_PetName(const shared_ptr<Client>& client, Seperator* sep);
  void Command_NamePet(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Rename(const shared_ptr<Client>& client, Seperator* sep);
  void Command_ConfirmRename(const shared_ptr<Client>& client, Seperator* sep);
  void Command_PetOptions(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Random(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Randomize(const shared_ptr<Client>& client, Seperator* sep);
  void Command_ReportBug(const shared_ptr<Client>& client, Seperator* sep);
  void Command_ShowCloak(const shared_ptr<Client>& client, Seperator* sep);
  void Command_ShowHelm(const shared_ptr<Client>& client, Seperator* sep);
  void Command_ShowHood(const shared_ptr<Client>& client, Seperator* sep);
  void Command_ShowHoodHelm(const shared_ptr<Client>& client, Seperator* sep);
  void Command_ShowRanged(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Skills(const shared_ptr<Client>& client, Seperator* sep, int handler);
  void Command_SpawnTemplate(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Speed(const shared_ptr<Client>& client, Seperator* sep);
  void Command_StationMarketPlace(const shared_ptr<Client>& client, Seperator* sep);
  void Command_StopEating(const shared_ptr<Client>& client);
  void Command_StopDrinking(const shared_ptr<Client>& client);
  void Command_Test(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Title(const shared_ptr<Client>& client);
  void Command_TitleList(const shared_ptr<Client>& client);
  void Command_TitleSetPrefix(const shared_ptr<Client>& client, Seperator* sep);
  void Command_TitleSetSuffix(const shared_ptr<Client>& client, Seperator* sep);
  void Command_TitleFix(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Toggle_Anonymous(const shared_ptr<Client>& client);
  void Command_Toggle_AutoConsume(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Toggle_BonusXP(const shared_ptr<Client>& client);
  void Command_Toggle_CombatXP(const shared_ptr<Client>& client);
  void Command_Toggle_GMHide(const shared_ptr<Client>& client);
  void Command_Toggle_GMVanish(const shared_ptr<Client>& client);
  void Command_Toggle_Illusions(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Toggle_LFG(const shared_ptr<Client>& client);
  void Command_Toggle_LFW(const shared_ptr<Client>& client);
  void Command_Toggle_QuestXP(const shared_ptr<Client>& client);
  void Command_Toggle_Roleplaying(const shared_ptr<Client>& client);
  void Command_Toggle_Duels(const shared_ptr<Client>& client);
  void Command_Toggle_Trades(const shared_ptr<Client>& client);
  void Command_Toggle_Guilds(const shared_ptr<Client>& client);
  void Command_Toggle_Groups(const shared_ptr<Client>& client);
  void Command_Toggle_Raids(const shared_ptr<Client>& client);
  void Command_Toggle_LON(const shared_ptr<Client>& client);
  void Command_Toggle_VoiceChat(const shared_ptr<Client>& client);
  void Command_Track(const shared_ptr<Client>& client);
  void Command_TradeStart(const shared_ptr<Client>& client, Seperator* sep);
  void Command_TradeAccept(const shared_ptr<Client>& client, Seperator* sep);
  void Command_TradeReject(const shared_ptr<Client>& client, Seperator* sep);
  void Command_TradeCancel(const shared_ptr<Client>& client, Seperator* sep);
  void Command_TradeSetCoin(const shared_ptr<Client>& client, Seperator* sep);
  void Command_TradeAddCoin(const shared_ptr<Client>& client, Seperator* sep, int handler);
  void Command_TradeRemoveCoin(const shared_ptr<Client>& client, Seperator* sep, int handler);
  void Command_TradeAddItem(const shared_ptr<Client>& client, Seperator* sep);
  void Command_TradeRemoveItem(const shared_ptr<Client>& client, Seperator* sep);
  void Command_TryOn(const shared_ptr<Client>& client, Seperator* sep);
  void Command_JoinChannel(const shared_ptr<Client>& client, Seperator* sep);
  void Command_JoinChannelFromLoad(const shared_ptr<Client>& client, Seperator* sep);
  void Command_TellChannel(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Mount(const shared_ptr<Client>& client, Seperator* sep);
  void Command_ResetEncounter(const shared_ptr<Client>& client);
  void Command_Knockback(const shared_ptr<Client>& client, Seperator* sep);
  void Command_LeaveChannel(const shared_ptr<Client>& client, Seperator* sep);
  void Command_WeaponStats(const shared_ptr<Client>& client);
  void Command_WhoChannel(const shared_ptr<Client>& client, Seperator* sep);
  void Command_ZoneSafeCoords(const shared_ptr<Client>& client, Seperator* sep);
  void Command_ZoneDetails(const shared_ptr<Client>& client, Seperator* sep);
  void Command_ZoneSet(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Rain(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Wind(const shared_ptr<Client>& client, Seperator* sep);
  void Command_SendMerchantWindow(const shared_ptr<Client>& client, Seperator* sep, bool sell = false);
  void Command_Weather(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Select(const shared_ptr<Client>& client, Seperator* sep);
  void Command_ConsumeFood(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Aquaman(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Attune_Inv(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Player(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Player_Set(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Player_Coins(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Reset_Zone_Timer(const shared_ptr<Client>& client, Seperator* sep);
  void Command_AchievementAdd(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Editor(const shared_ptr<Client>& client, Seperator* sep);
  void Command_AcceptResurrection(const shared_ptr<Client>& client, Seperator* sep);
  void Command_DeclineResurrection(const shared_ptr<Client>& client, Seperator* set);

  // Bot Commands
  void Command_Bot(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Bot_Create(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Bot_Customize(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Bot_Spawn(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Bot_List(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Bot_Inv(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Bot_Settings(const shared_ptr<Client>& client, Seperator* sep);
  void Command_Bot_Help(const shared_ptr<Client>& client, Seperator* sep);

  void Command_ServerFlag(const shared_ptr<Client>& client, Seperator* sep);

  void Command_PVPRange(const shared_ptr<Client>& client);

  void Command_PVP(const shared_ptr<Client>& client);
