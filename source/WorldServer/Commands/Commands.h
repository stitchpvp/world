...
public:
	Commands();
	~Commands();
	bool SetSpawnCommand(shared_ptr<Client> client, Spawn* target, int8 type, const char* value, bool send_update = true, bool temporary = false, string* temp_value = 0);
	bool SetZoneCommand(shared_ptr<Client> client, int32 zone_id, ZoneServer* zone, int8 type, const char* value);
	RemoteCommands* GetRemoteCommands() { return remote_commands; }
	void	Process(int32 index, EQ2_16BitString* command_parms, shared_ptr<Client> client);
	int32 GetCommandHandler(const char* name){
	...
	void Command_AcceptAdvancement(shared_ptr<Client> client, Seperator* sep);
	void Command_AFK(shared_ptr<Client> client, Seperator* sep);
	void Command_Appearance(shared_ptr<Client> client, Seperator* sep, int handler);
	void Command_CancelMaintained(shared_ptr<Client> client, Seperator* sep);
	void Command_Claim(shared_ptr<Client> client, Seperator* sep);
	void Command_ClearAllQueued(shared_ptr<Client> client);
	void Command_Create(shared_ptr<Client> client, Seperator* sep);
	void Command_CreateFromRecipe(shared_ptr<Client> client, Seperator* sep);
	void Command_Distance(shared_ptr<Client> client);
	void Command_Duel(shared_ptr<Client> client, Seperator* sep);
	void Command_DuelBet(shared_ptr<Client> client, Seperator* sep);
	void Command_DuelAccept(shared_ptr<Client> client, Seperator* sep);
	void Command_DuelDecline(shared_ptr<Client> client, Seperator* sep);
	void Command_DuelSurrender(shared_ptr<Client> client, Seperator* sep);
	void Command_DuelToggle(shared_ptr<Client> client, Seperator* sep);
	void Command_EntityCommand(shared_ptr<Client> client, Seperator* sep, int handler);
	void Command_Follow(shared_ptr<Client> client, Seperator* sep);
	void Command_StopFollow(shared_ptr<Client> client, Seperator* sep);
	void Command_Grid(shared_ptr<Client> client);
	void Command_Guild(shared_ptr<Client> client, Seperator* sep);
	void Command_CreateGuild(shared_ptr<Client> client);
	void Command_SetGuildOfficerNote(shared_ptr<Client> client, Seperator* sep);
	void Command_SetGuildMemberNote(shared_ptr<Client> client, Seperator* sep);
	void Command_OfficerSay(shared_ptr<Client> client, Seperator* sep);
	void Command_GuildSay(shared_ptr<Client> client, Seperator* sep);
	void Command_Guilds(shared_ptr<Client> client);
	void Command_GuildsAdd(shared_ptr<Client> client, Seperator* sep);
	void Command_GuildsCreate(shared_ptr<Client> client, Seperator* sep);
	void Command_GuildsDelete(shared_ptr<Client> client, Seperator* sep);
	void Command_GuildsList(shared_ptr<Client> client);
	void Command_GuildsRemove(shared_ptr<Client> client, Seperator* sep);
	void Command_InspectPlayer(shared_ptr<Client> client, Seperator* sep);
	void Command_Inventory(shared_ptr<Client> client, Seperator* sep, EQ2_RemoteCommandString* command);
	void Command_IRC(shared_ptr<Client> client, Seperator* sep);
	void Command_Languages(shared_ptr<Client> client, Seperator* sep);
	void Command_SetLanguage(shared_ptr<Client> client, Seperator* sep);
	void Command_LastName(shared_ptr<Client> client, Seperator* sep);
	void Command_ConfirmLastName(shared_ptr<Client> client, Seperator* sep);
	void Command_Location(shared_ptr<Client> client);
	void Command_LocationAdd(shared_ptr<Client> client, Seperator* sep);
	void Command_LocationCreate(shared_ptr<Client> client, Seperator* sep);
	void Command_LocationDelete(shared_ptr<Client> client, Seperator* sep);
	void Command_LocationList(shared_ptr<Client> client, Seperator* sep);
	void Command_LocationRemove(shared_ptr<Client> client, Seperator* sep);
	void Command_Merchant(shared_ptr<Client> client, Seperator* sep, int handler);

	void Command_Modify(shared_ptr<Client> client); // usage function
	void Command_ModifyCharacter(shared_ptr<Client> client, Seperator* sep);
	void Command_ModifyFaction(shared_ptr<Client> client, Seperator* sep);
	void Command_ModifyGuild(shared_ptr<Client> client, Seperator* sep);
	void Command_ModifyItem(shared_ptr<Client> client, Seperator* sep);
	void Command_ModifyQuest(shared_ptr<Client> client, Seperator* sep);
	void Command_ModifySkill(shared_ptr<Client> client, Seperator* sep);
	void Command_ModifySpawn(shared_ptr<Client> client, Seperator* sep);
	void Command_ModifySpell(shared_ptr<Client> client, Seperator* sep);
	void Command_ModifyZone(shared_ptr<Client> client, Seperator* sep);

	void Command_MOTD(shared_ptr<Client> client);
	void Command_Pet(shared_ptr<Client> client, Seperator* sep);
	void Command_PetName(shared_ptr<Client> client, Seperator* sep);
	void Command_NamePet(shared_ptr<Client> client, Seperator* sep);
	void Command_Rename(shared_ptr<Client> client, Seperator* sep);
	void Command_ConfirmRename(shared_ptr<Client> client, Seperator* sep);
	void Command_PetOptions(shared_ptr<Client> client, Seperator* sep);
	void Command_Random(shared_ptr<Client> client, Seperator* sep);
	void Command_Randomize(shared_ptr<Client> client, Seperator* sep);
	void Command_ReportBug(shared_ptr<Client> client, Seperator* sep);
	void Command_ShowCloak(shared_ptr<Client> client, Seperator* sep);
	void Command_ShowHelm(shared_ptr<Client> client, Seperator* sep);
	void Command_ShowHood(shared_ptr<Client> client, Seperator* sep);
	void Command_ShowHoodHelm(shared_ptr<Client> client, Seperator* sep);
	void Command_ShowRanged(shared_ptr<Client> client, Seperator* sep);
	void Command_Skills(shared_ptr<Client> client, Seperator* sep, int handler);
	void Command_SpawnTemplate(shared_ptr<Client> client, Seperator* sep);
	void Command_Speed(shared_ptr<Client> client, Seperator* sep);
	void Command_StationMarketPlace(shared_ptr<Client> client, Seperator* sep);
	void Command_StopEating(shared_ptr<Client> client);
	void Command_StopDrinking(shared_ptr<Client> client);
	void Command_Test(shared_ptr<Client> client, Seperator* sep);
	void Command_Title(shared_ptr<Client> client);
	void Command_TitleList(shared_ptr<Client> client);
	void Command_TitleSetPrefix(shared_ptr<Client> client, Seperator* sep);
	void Command_TitleSetSuffix(shared_ptr<Client> client, Seperator* sep);
	void Command_TitleFix(shared_ptr<Client> client, Seperator* sep);
	void Command_Toggle_Anonymous(shared_ptr<Client> client);
	void Command_Toggle_AutoConsume(shared_ptr<Client> client, Seperator* sep);
	void Command_Toggle_BonusXP(shared_ptr<Client> client);
	void Command_Toggle_CombatXP(shared_ptr<Client> client);
	void Command_Toggle_GMHide(shared_ptr<Client> client);
	void Command_Toggle_GMVanish(shared_ptr<Client> client);
	void Command_Toggle_Illusions(shared_ptr<Client> client, Seperator* sep);
	void Command_Toggle_LFG(shared_ptr<Client> client);
	void Command_Toggle_LFW(shared_ptr<Client> client);
	void Command_Toggle_QuestXP(shared_ptr<Client> client);
	void Command_Toggle_Roleplaying(shared_ptr<Client> client);
	void Command_Toggle_Duels(shared_ptr<Client> client);
	void Command_Toggle_Trades(shared_ptr<Client> client);
	void Command_Toggle_Guilds(shared_ptr<Client> client);
	void Command_Toggle_Groups(shared_ptr<Client> client);
	void Command_Toggle_Raids(shared_ptr<Client> client);
	void Command_Toggle_LON(shared_ptr<Client> client);
	void Command_Toggle_VoiceChat(shared_ptr<Client> client);
	void Command_Track(shared_ptr<Client> client);
	void Command_TradeStart(shared_ptr<Client> client, Seperator* sep);
	void Command_TradeAccept(shared_ptr<Client> client, Seperator* sep);
	void Command_TradeReject(shared_ptr<Client> client, Seperator* sep);
	void Command_TradeCancel(shared_ptr<Client> client, Seperator* sep);
	void Command_TradeSetCoin(shared_ptr<Client> client, Seperator* sep);
	void Command_TradeAddCoin(shared_ptr<Client> client, Seperator* sep, int handler);
	void Command_TradeRemoveCoin(shared_ptr<Client> client, Seperator* sep, int handler);
	void Command_TradeAddItem(shared_ptr<Client> client, Seperator* sep);
	void Command_TradeRemoveItem(shared_ptr<Client> client, Seperator* sep);
	void Command_TryOn(shared_ptr<Client> client, Seperator* sep);
	void Command_JoinChannel(shared_ptr<Client> client, Seperator *sep);
	void Command_JoinChannelFromLoad(shared_ptr<Client> client, Seperator *sep);
	void Command_TellChannel(shared_ptr<Client> client, Seperator *sep);
	void Command_Mount(shared_ptr<Client> client, Seperator* sep);
	void Command_ResetEncounter(shared_ptr<Client> client);
	void Command_Knockback(shared_ptr<Client> client, Seperator* sep);
	void Command_LeaveChannel(shared_ptr<Client> client, Seperator *sep);
	void Command_WeaponStats(shared_ptr<Client> client);
	void Command_WhoChannel(shared_ptr<Client> client, Seperator *sep);
	void Command_ZoneSafeCoords(shared_ptr<Client> client, Seperator *sep);
	void Command_ZoneDetails(shared_ptr<Client> client, Seperator *sep);
	void Command_ZoneSet(shared_ptr<Client> client, Seperator *sep);
	void Command_Rain(shared_ptr<Client> client, Seperator* sep);
	void Command_Wind(shared_ptr<Client> client, Seperator* sep);
	void Command_SendMerchantWindow(shared_ptr<Client> client, Seperator* sep, bool sell = false);
	void Command_Weather(shared_ptr<Client> client, Seperator* sep);
	void Command_Select(shared_ptr<Client> client, Seperator* sep);
	void Command_ConsumeFood(shared_ptr<Client> client, Seperator* sep);
	void Command_Aquaman(shared_ptr<Client> client, Seperator* sep);
	void Command_Attune_Inv(shared_ptr<Client> client, Seperator* sep);
	void Command_Player(shared_ptr<Client> client, Seperator* sep);
	void Command_Player_Set(shared_ptr<Client> client, Seperator* sep);
	void Command_Player_Coins(shared_ptr<Client> client, Seperator* sep);
	void Command_Reset_Zone_Timer(shared_ptr<Client> client, Seperator* sep);
	void Command_AchievementAdd(shared_ptr<Client> client, Seperator* sep);
	void Command_Editor(shared_ptr<Client> client, Seperator* sep);
	void Command_AcceptResurrection(shared_ptr<Client> client, Seperator* sep);
	void Command_DeclineResurrection(shared_ptr<Client> client, Seperator* set);

	// Bot Commands
	void Command_Bot(shared_ptr<Client> client, Seperator* sep);
	void Command_Bot_Create(shared_ptr<Client> client, Seperator* sep);
	void Command_Bot_Customize(shared_ptr<Client> client, Seperator* sep);
	void Command_Bot_Spawn(shared_ptr<Client> client, Seperator* sep);
	void Command_Bot_List(shared_ptr<Client> client, Seperator* sep);
	void Command_Bot_Inv(shared_ptr<Client> client, Seperator* sep);
	void Command_Bot_Settings(shared_ptr<Client> client, Seperator* sep);
	void Command_Bot_Help(shared_ptr<Client> client, Seperator* sep);

	void Command_ServerFlag(shared_ptr<Client> client, Seperator* sep);

	void Command_PVPRange(shared_ptr<Client> client);

	void Command_PVP(shared_ptr<Client> client);

	void Command_KnowledgeWindow_Sort(shared_ptr<Client> client, Seperator* sep);
	void Command_Heal(shared_ptr<Client> client);
