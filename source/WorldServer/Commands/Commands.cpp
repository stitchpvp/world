...
void Commands::Process(int32 index, EQ2_16BitString* command_parms, const shared_ptr<Client>& client) {
  ...
  case COMMAND_USEABILITY: {
    if (sep && sep->IsSet(0)) {
      ...
      if (sep->IsNumber(0)) {
        ...
        const char* spell_name = sep->argplus[0];
        Spell* spell = master_spell_list.GetSpellByName(spell_name);
  ...
  case COMMAND_SET_MAIL_ITEM: {
    ...
    if (sep && sep->arg[0])
      LogWrite(COMMAND__DEBUG, 0, "Command", "%s\n", sep->argplus[0]);
    break;
  }
  ...
  case COMMAND_REPORT_BUG: {
    Command_ReportBug(client, sep);
    break;
  }
  case COMMAND_INVENTORY: {
    Command_Inventory(client, sep, command);
    break;
  }
  case COMMAND_WEAPONSTATS: {
    Command_WeaponStats(client);
    break;
  }
  case COMMAND_SKILL:
  ...
  case COMMAND_SKILL_LIST: {
    Command_Skills(client, sep, command->handler);
    break;
  }
  case COMMAND_ZONE_SET: {
    Command_ZoneSet(client, sep);
    break;
  }
  case COMMAND_ZONE_DETAILS: {
    Command_ZoneDetails(client, sep);
    break;
  }
  case COMMAND_ENTITYCOMMAND:
  case COMMAND_ENTITYCOMMAND_LIST: {
    Command_EntityCommand(client, sep, command->handler);
    break;
  }
  case COMMAND_MERCHANT:
  case COMMAND_MERCHANT_LIST: {
    Command_Merchant(client, sep, command->handler);
    break;
  }
  case COMMAND_APPEARANCE:
  case COMMAND_APPEARANCE_LIST: {
    Command_Appearance(client, sep, command->handler);
    break;
  }
  case COMMAND_TRACK: {
    Command_Track(client);
    break;
  }
  case COMMAND_DISTANCE: {
    Command_Distance(client);
    break;
  }
  case COMMAND_INSPECT_PLAYER: {
    Command_InspectPlayer(client, sep);
    break;
  }
  case COMMAND_ZONE_SAFE: {
    Command_ZoneSafeCoords(client, sep);
    break;
  }
  case COMMAND_GUILDSAY: {
    Command_GuildSay(client, sep);
    break;
  }
  case COMMAND_OFFICERSAY: {
    Command_OfficerSay(client, sep);
    break;
  }
  case COMMAND_SET_GUILD_MEMBER_NOTE: {
    Command_SetGuildMemberNote(client, sep);
    break;
  }
  case COMMAND_SET_GUILD_OFFICER_NOTE: {
    Command_SetGuildOfficerNote(client, sep);
    break;
  }
  case COMMAND_GUILD: {
    Command_Guild(client, sep);
    break;
  }
  case COMMAND_CREATE_GUILD: {
    Command_CreateGuild(client);
    break;
  }
  case COMMAND_GUILDS: {
    Command_Guilds(client);
    break;
  }
  case COMMAND_GUILDS_ADD: {
    Command_GuildsAdd(client, sep);
    break;
  }
  case COMMAND_GUILDS_CREATE: {
    Command_GuildsCreate(client, sep);
    break;
  }
  case COMMAND_GUILDS_DELETE: {
    Command_GuildsDelete(client, sep);
    break;
  }
  case COMMAND_GUILDS_LIST: {
    Command_GuildsList(client);
    break;
  }
  case COMMAND_GUILDS_REMOVE: {
    Command_GuildsRemove(client, sep);
    break;
  }
  case COMMAND_CLAIM: {
    Command_Claim(client, sep);
    break;
  }
  case COMMAND_CLEAR_ALL_QUEUED: {
    Command_ClearAllQueued(client);
    break;
  }
  case COMMAND_LOCATION: {
    Command_Location(client);
    break;
  }
  case COMMAND_LOCATION_ADD: {
    Command_LocationAdd(client, sep);
    break;
  }
  case COMMAND_LOCATION_CREATE: {
    Command_LocationCreate(client, sep);
    break;
  }
  case COMMAND_LOCATION_DELETE: {
    Command_LocationDelete(client, sep);
    break;
  }
  case COMMAND_LOCATION_LIST: {
    Command_LocationList(client, sep);
    break;
  }
  case COMMAND_LOCATION_REMOVE: {
    Command_LocationRemove(client, sep);
    break;
  }
  case COMMAND_GRID: {
    Command_Grid(client);
  ...
  case COMMAND_TRY_ON: {
    Command_TryOn(client, sep);
    break;
  }
  case COMMAND_IRC: {
    Command_IRC(client, sep);
    break;
  }
  case COMMAND_RANDOMIZE: {
    Command_Randomize(client, sep);
    break;
  }
  case COMMAND_AFK: {
    Command_AFK(client, sep);
    break;
  }
  case COMMAND_SHOW_CLOAK: {
    Command_ShowCloak(client, sep);
    break;
  }
  case COMMAND_SHOW_HELM: {
    Command_ShowHelm(client, sep);
    break;
  }
  case COMMAND_SHOW_HOOD: {
    Command_ShowHood(client, sep);
    break;
  }
  case COMMAND_SHOW_HOOD_OR_HELM: {
    Command_ShowHoodHelm(client, sep);
    break;
  }
  case COMMAND_SHOW_RANGED: {
    Command_ShowRanged(client, sep);
    break;
  }
  case COMMAND_STOP_DRINKING: {
    Command_StopDrinking(client);
    break;
  }
  case COMMAND_STOP_EATING: {
    Command_StopEating(client);
    break;
  }
  case COMMAND_TOGGLE_ANONYMOUS: {
    Command_Toggle_Anonymous(client);
    break;
  }
  case COMMAND_TOGGLE_AUTOCONSUME: {
    Command_Toggle_AutoConsume(client, sep);
    break;
  }
  case COMMAND_TOGGLE_BONUS_EXP: {
    Command_Toggle_BonusXP(client);
    break;
  }
  case COMMAND_TOGGLE_COMBAT_EXP: {
    Command_Toggle_CombatXP(client);
    break;
  }
  case COMMAND_TOGGLE_GM_HIDE: {
    Command_Toggle_GMHide(client);
    break;
  }
  case COMMAND_TOGGLE_GM_VANISH: {
    Command_Toggle_GMVanish(client);
    break;
  }
  case COMMAND_TOGGLE_ILLUSIONS: {
    Command_Toggle_Illusions(client, sep);
    break;
  }
  case COMMAND_TOGGLE_LFG: {
    Command_Toggle_LFG(client);
    break;
  }
  case COMMAND_TOGGLE_LFW: {
    Command_Toggle_LFW(client);
    break;
  }
  case COMMAND_TOGGLE_QUEST_EXP: {
    Command_Toggle_QuestXP(client);
    break;
  }
  case COMMAND_TOGGLE_ROLEPLAYING: {
    Command_Toggle_Roleplaying(client);
    break;
  }
  case COMMAND_TOGGLE_DUELS: {
    Command_Toggle_Duels(client);
    break;
  }
  case COMMAND_TOGGLE_TRADES: {
    Command_Toggle_Trades(client);
    break;
  }
  case COMMAND_TOGGLE_GUILDS: {
    Command_Toggle_Guilds(client);
    break;
  }
  case COMMAND_TOGGLE_GROUPS: {
    Command_Toggle_Groups(client);
    break;
  }
  case COMMAND_TOGGLE_RAIDS: {
    Command_Toggle_Raids(client);
    break;
  }
  case COMMAND_TOGGLE_LON: {
    Command_Toggle_LON(client);
    break;
  }
  case COMMAND_TOGGLE_VCINVITE: {
    Command_Toggle_VoiceChat(client);
    break;
  }
  case COMMAND_CANCEL_MAINTAINED: {
    Command_CancelMaintained(client, sep);
    break;
  }
  case COMMAND_MOTD: {
    Command_MOTD(client);
  ...
  case COMMAND_RANDOM: {
    Command_Random(client, sep);
    break;
  }
  case COMMAND_CREATE: {
    Command_Create(client, sep);
    break;
  }
  case COMMAND_CREATEFROMRECIPE: {
    Command_CreateFromRecipe(client, sep);
    break;
  }
  case COMMAND_TITLE: {
    Command_Title(client);
    break;
  }
  case COMMAND_TITLE_LIST: {
    Command_TitleList(client);
    break;
  }
  case COMMAND_TITLE_SETPREFIX: {
    Command_TitleSetPrefix(client, sep);
    break;
  }
  case COMMAND_TITLE_SETSUFFIX: {
    Command_TitleSetSuffix(client, sep);
    break;
  }
  case COMMAND_TITLE_FIX: {
    Command_TitleFix(client, sep);
    break;
  }
  case COMMAND_LANGUAGES: {
    Command_Languages(client, sep);
    break;
  }
  case COMMAND_SET_LANGUAGE: {
    Command_SetLanguage(client, sep);
    break;
  }
  case COMMAND_FOLLOW: {
    Command_Follow(client, sep);
    break;
  }
  case COMMAND_STOP_FOLLOW: {
    Command_StopFollow(client, sep);
    break;
  }
  case COMMAND_LASTNAME: {
    Command_LastName(client, sep);
    break;
  }
  case COMMAND_CONFIRMLASTNAME: {
    Command_ConfirmLastName(client, sep);
    break;
  }
  case COMMAND_PET: {
    Command_Pet(client, sep);
    break;
  }
  case COMMAND_PETNAME: {
    Command_PetName(client, sep);
    break;
  }
  case COMMAND_NAME_PET: {
    Command_NamePet(client, sep);
    break;
  }
  case COMMAND_RENAME: {
    Command_Rename(client, sep);
    break;
  }
  case COMMAND_CONFIRMRENAME: {
    Command_ConfirmRename(client, sep);
    break;
  }
  case COMMAND_PETOPTIONS: {
    Command_PetOptions(client, sep);
    break;
  }
  case COMMAND_START_TRADE: {
    Command_TradeStart(client, sep);
    break;
  }
  case COMMAND_ACCEPT_TRADE: {
    Command_TradeAccept(client, sep);
    break;
  }
  case COMMAND_REJECT_TRADE: {
    Command_TradeReject(client, sep);
    break;
  }
  case COMMAND_CANCEL_TRADE: {
    Command_TradeCancel(client, sep);
    break;
  }
  case COMMAND_SET_TRADE_COIN: {
    Command_TradeSetCoin(client, sep);
    break;
  }
  case COMMAND_ADD_TRADE_COPPER: {
    Command_TradeAddCoin(client, sep, COMMAND_ADD_TRADE_COPPER);
    break;
  }
  case COMMAND_ADD_TRADE_SILVER: {
    Command_TradeAddCoin(client, sep, COMMAND_ADD_TRADE_SILVER);
    break;
  }
  case COMMAND_ADD_TRADE_GOLD: {
    Command_TradeAddCoin(client, sep, COMMAND_ADD_TRADE_GOLD);
    break;
  }
  case COMMAND_ADD_TRADE_PLAT: {
    Command_TradeAddCoin(client, sep, COMMAND_ADD_TRADE_PLAT);
    break;
  }
  ...
  case COMMAND_REMOVE_TRADE_GOLD: {
    Command_TradeRemoveCoin(client, sep, COMMAND_REMOVE_TRADE_GOLD);
    break;
  }
  case COMMAND_REMOVE_TRADE_PLAT: {
    Command_TradeRemoveCoin(client, sep, COMMAND_REMOVE_TRADE_PLAT);
    break;
  }
  case COMMAND_ADD_TRADE_ITEM: {
    Command_TradeAddItem(client, sep);
    break;
  }
  case COMMAND_REMOVE_TRADE_ITEM: {
    Command_TradeRemoveItem(client, sep);
    break;
  }
  case COMMAND_ACCEPT_ADVANCEMENT: {
    Command_AcceptAdvancement(client, sep);
    break;
  }
  case COMMAND_DUEL: {
    Command_Duel(client, sep);
    break;
  }
  case COMMAND_DUELBET: {
    Command_DuelBet(client, sep);
    break;
  }
  case COMMAND_DUEL_ACCEPT: {
    Command_DuelAccept(client, sep);
    break;
  }
  case COMMAND_DUEL_DECLINE: {
    Command_DuelDecline(client, sep);
    break;
  }
  case COMMAND_DUEL_SURRENDER: {
    Command_DuelSurrender(client, sep);
    break;
  }
  case COMMAND_DUEL_TOGGLE: {
    Command_DuelToggle(client, sep);
    break;
  }
  case COMMAND_SPAWN_TEMPLATE: {
    Command_SpawnTemplate(client, sep);
    break;
  }
  ...
  case COMMAND_MODIFY_CHARACTER: {
    Command_ModifyCharacter(client, sep);
    break;
  }
  case COMMAND_MODIFY_QUEST: {
    Command_ModifyQuest(client, sep);
    break;
  }
  case COMMAND_MODIFY_FACTION: {
    Command_ModifyFaction(client, sep);
    break;
  }
  case COMMAND_MODIFY_GUILD: {
    Command_ModifyGuild(client, sep);
    break;
  }
  case COMMAND_MODIFY_ITEM: {
    Command_ModifyItem(client, sep);
    break;
  }
  case COMMAND_MODIFY_SKILL: {
    Command_ModifySkill(client, sep);
    break;
  }
  case COMMAND_MODIFY_SPAWN: {
    Command_ModifySpawn(client, sep);
    break;
  }
  case COMMAND_MODIFY_SPELL: {
    Command_ModifySpell(client, sep);
    break;
  }
  case COMMAND_MODIFY_ZONE: {
    Command_ModifyZone(client, sep);
    break;
  }
  ...
  case COMMAND_JOIN_CHANNEL_FROM_LOAD: {
    Command_JoinChannelFromLoad(client, sep);
    break;
  }
  case COMMAND_TELL_CHANNEL: {
    Command_TellChannel(client, sep);
    break;
  }
  case COMMAND_LEAVE_CHANNEL: {
    Command_LeaveChannel(client, sep);
    break;
  }
  case COMMAND_WHO_CHANNEL: {
    Command_WhoChannel(client, sep);
    break;
  }
  case COMMAND_RAIN: {
    Command_Rain(client, sep);
    break;
  }
  case COMMAND_WIND: {
    Command_Wind(client, sep);
    break;
  }
  case COMMAND_WEATHER: {
    Command_Weather(client, sep);
    break;
  }
  case COMMAND_FROM_MERCHANT: {
    Command_SendMerchantWindow(client, sep);
    break;
  }
  case COMMAND_TO_MERCHANT: {
    Command_SendMerchantWindow(client, sep, true);
    break;
  }
  case COMMAND_SELECT: {
    Command_Select(client, sep);
    break;
  }
  case COMMAND_SMP: {
    Command_StationMarketPlace(client, sep);
    break;
  }
  case COMMAND_CONSUME_FOOD: {
    Command_ConsumeFood(client, sep);
    break;
  }
  case COMMAND_AQUAMAN: {
    Command_Aquaman(client, sep);
    break;
  }
  case COMMAND_ATTUNE_INV: {
    Command_Attune_Inv(client, sep);
    break;
  }
  case COMMAND_PLAYER: {
    Command_Player(client, sep);
    break;
  }
  case COMMAND_PLAYER_COINS: {
    Command_Player_Coins(client, sep);
    break;
  }
  case COMMAND_PLAYER_SET: {
    Command_Player_Set(client, sep);
    break;
  }
  case COMMAND_RESET_ZONE_TIMER: {
    Command_Reset_Zone_Timer(client, sep);
    break;
  }
  case COMMAND_ACHIEVEMENT_ADD: {
    Command_AchievementAdd(client, sep);
    break;
  }
  case COMMAND_EDITOR: {
    Command_Editor(client, sep);
    break;
  }
  case COMMAND_ACCEPT_RESURRECTION: {
    Command_AcceptResurrection(client, sep);
    break;
  }
  case COMMAND_DECLINE_RESURRECTION: {
    Command_DeclineResurrection(client, sep);
    break;
  }
  case COMMAND_TEST: {
    Command_Test(client, sep);
    break;
  }
  case COMMAND_MOUNT: {
    Command_Mount(client, sep);
    break;
  }
  case COMMAND_SPEED: {
    Command_Speed(client, sep);
    break;
  }
  case COMMAND_SERVER_FLAG: {
    Command_ServerFlag(client, sep);
    break;
  }
  case COMMAND_PVP_RANGE: {
    Command_PVPRange(client);
    break;
  }
  case COMMAND_PVP: {
    Command_PVP(client);
  ...
  case COMMAND_KNOWLEDGEWINDOW_SORT: {
    Command_KnowledgeWindow_Sort(client, sep);
    break;
  }
  case COMMAND_RESET_ENCOUNTER: {
    Command_ResetEncounter(client);
    break;
  }
  case COMMAND_KNOCKBACK: {
    Command_Knockback(client, sep);
    break;
  }
  case COMMAND_HEAL: {
    Command_Heal(client);
  ...
  case COMMAND_BOT_CREATE: {
    Command_Bot_Create(client, sep);
    break;
  }
  case COMMAND_BOT_CUSTOMIZE: {
    Command_Bot_Customize(client, sep);
    break;
  }
  case COMMAND_BOT_SPAWN: {
    Command_Bot_Spawn(client, sep);
    break;
  }
  case COMMAND_BOT_LIST: {
    Command_Bot_List(client, sep);
    break;
  }
  case COMMAND_BOT_INV: {
    Command_Bot_Inv(client, sep);
    break;
  }
  case COMMAND_BOT_SETTINGS: {
    Command_Bot_Settings(client, sep);
    break;
  }
  case COMMAND_BOT_HELP: {
    Command_Bot_Help(client, sep);
    break;
  }
