...
public:
	...
	void SavePlayerActiveSpells(shared_ptr<Client> client);
	void DeleteCharacterActiveSpells(shared_ptr<Client> client, bool delete_all = false);
	int32	LoadItemBlueStats();
	void	SaveQuickBar(int32 char_id, vector<QuickBarItem*>* quickbar_items);
	void	SavePlayerSpells(shared_ptr<Client> client);
	int32	LoadSkills();
	...
	void	Save(shared_ptr<Client> client);
	void	SaveItems(shared_ptr<Client> client);
	...
	void	LoadBuyBacks(shared_ptr<Client> client);
	void	SaveBuyBacks(shared_ptr<Client> client);
	...
	void	SaveCharacterSkills(shared_ptr<Client> client);
	void	SaveCharacterQuests(shared_ptr<Client> client);
	void	SaveCharacterQuestProgress(shared_ptr<Client> client, Quest* quest);
	void	DeleteCharacterQuest(int32 quest_id, int32 char_id, bool repeated_quest = false);
	void	LoadCharacterQuests(shared_ptr<Client> client);
	void	LoadCharacterQuestProgress(shared_ptr<Client> client);
	...
	bool	LoadPlayerFactions(shared_ptr<Client> client);
	void	SavePlayerFactions(shared_ptr<Client> client);
	...
	int32	LoadAppearances(ZoneServer* zone, shared_ptr<Client> client = 0);
	...
	bool	loadCharacter(const char* name, int32 account_id, shared_ptr<Client> client);
	bool	LoadCharacterStats(int32 id, int32 account_id, shared_ptr<Client> client);
	...
	void	SavePlayerMail(shared_ptr<Client> client);
	void	LoadPlayerMail(shared_ptr<Client> client, bool new_only = false);
	...
	void	LoadTraits();
	int32	LoadPlayerSkillbar(shared_ptr<Client> client);
	string	GetColumnNames(char* name);

	string	GetZoneName(char* zone_description);
	bool	GetItemResultsToClient (shared_ptr<Client> client, const char* varSearch, int maxResults=20);
	...
	void ToggleCharacterOnline(shared_ptr<Client> client, int8 toggle);
	...
	bool				LoadCharacterInstances(shared_ptr<Client> client);
	//
	...
	void				ListLocations(shared_ptr<Client> client);
	void				ListLocationPoints(shared_ptr<Client> client, int32 location_id);
	...
	void				SavePlayerCollections(shared_ptr<Client> client);
	void				SavePlayerCollection(shared_ptr<Client> client, Collection *collection);
	void				SavePlayerCollectionItems(shared_ptr<Client> client, Collection *collection);
	void				SavePlayerCollectionItem(shared_ptr<Client> client, Collection *collection, int32 item_id);
	...
	int32				CreateSpawnFromTemplateByID(shared_ptr<Client> client, int32 template_id);
	int32				CreateSpawnFromTemplateByName(shared_ptr<Client> client, const char* template_name);
	...
	void				SaveCharPrefixIndex(sint16 index, int32 char_id, shared_ptr<Client> client);
	void				SaveCharSuffixIndex(sint16 index, int32 char_id, shared_ptr<Client> client);

	/* Languages */
	void				LoadLanguages();
	int32				LoadCharacterLanguages(int32 char_id, Player *player);
	int16				GetCharacterCurrentLang(int32 char_id, Player *player);
	void				SaveCharacterCurrentLang(int32 id, int32 char_id, shared_ptr<Client> client);
	...
	void				SaveCharRepeatableQuest(shared_ptr<Client> client, int32 quest_id, int16 quest_complete_count);
